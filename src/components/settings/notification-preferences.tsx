...
import { Bell, Mail, Megaphone, Clock } from 'lucide-react'
...
export function NotificationPreferences({
  ...
  const handleToggle = useCallback(
    (key: 'inquiryUpdates' | 'marketing' | 'reminders', value: boolean) => {
  ...
  const handleSave = useCallback(async () => {
    await onSave({ inquiryUpdates, marketing, reminders })
    setHasChanges(false)
  }, [inquiryUpdates, marketing, reminders, onSave])
